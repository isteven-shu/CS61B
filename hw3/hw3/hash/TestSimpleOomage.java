...
public class TestSimpleOomage {
    ...
    public void testHashCodePerfect() {
        ...
        SimpleOomage o4 = new SimpleOomage(20, 5, 10);
        SimpleOomage o5 = new SimpleOomage(10, 20, 5);
        SimpleOomage o6 = new SimpleOomage(20, 10, 5);

        SimpleOomage e6 = new SimpleOomage(20, 10, 5);
        SimpleOomage e5 = new SimpleOomage(10, 20, 5);

        assertEquals(o5.hashCode(), e5.hashCode());
        assertEquals(o6.hashCode(), e6.hashCode());
